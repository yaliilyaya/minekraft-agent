...
function FoundationPlaceFinder(bot, mcData) {
    ...
    this.crateSearchArea = function (position, buildArea) {
        ...
        searchArea.start = new vec3(
            buildArea.begin.x  * -1 * this.searchAreaMultiplier + positionInt.x,
            positionInt.y,
            buildArea.begin.z  * -1 * this.searchAreaMultiplier + positionInt.z
        )
        searchArea.end = new vec3(
            buildArea.end.x  * this.searchAreaMultiplier + positionInt.x,
            positionInt.y + buildArea.getHeight(),
            buildArea.end.z  * this.searchAreaMultiplier + positionInt.z
        )
