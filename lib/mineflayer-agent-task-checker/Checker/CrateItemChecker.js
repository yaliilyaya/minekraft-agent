function CrateItemChecker(AgentInventory, AgentCraft) {
    ...
    this.check = async (task) => {
        ...
        //TODO:: нужно кешировать данные о верстаке и рецепт всегда должен быть найден
        // если рецепт не найден то нужно создать задачу на добычу
