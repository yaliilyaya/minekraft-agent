...
function AgentTaskChecker () {
  ...
  this.init = () => {
    ...
    this.CrateItemChecker = new CrateItemChecker(this.AgentInventory, this.AgentRecipeInfo, this.AgentCraft)
...
module.exports = {
  AgentTaskCheckerBuilder: (AgentInventory, AgentRecipeInfo, AgentCraft) => {
