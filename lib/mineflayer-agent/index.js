...
function Agent () {
  ...
  this.connection = () => {
    ...
    this.AgentInventory = AgentInventoryBuilder(this.bot);

    this.AgentDig = AgentDigBuilder(this.bot, this.AgentFinder);
    this.AgentTask = AgentTaskBuilder(this.bot, this.AgentBlockInfo, this.AgentDig, this.AgentInventory, this.AgentFinder);
  ...
  this.onSpawn = async () => {
    ...
    // await this.AgentTask.runTaskDigBlocks('dirt', 3);
  }
