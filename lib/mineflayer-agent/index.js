...
function Agent () {
  ...
  this.connection = () => {
    ...
    this.AgentRecipeInfo = AgentRecipeInfoBuilder(this.bot, this.mcData)
    ...
    this.AgentCraft = AgentCraftBuilder(this.bot, this.AgentBlockInfo, this.AgentFinder)
    ...
    this.AgentTaskChecker = AgentTaskCheckerBuilder(this.AgentInventory, this.AgentRecipeInfo)
