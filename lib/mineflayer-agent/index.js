...
function Agent () {
  ...
  this.connection = () => {
    ...
    this.AgentCraft = AgentCraftBuilder(this.bot, this.AgentBlockInfo)
    ...
    this.AgentTaskChecker = AgentTaskCheckerBuilder(this.AgentInventory)
  ...
  this.onSpawn = async () => {
    ...
    // await this.AgentTask.craftItemInInventory('oak_planks', 1);
    // await this.AgentTask.craftItemInCraftingTable('wooden_axe', 1);
